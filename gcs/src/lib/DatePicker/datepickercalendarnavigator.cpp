...
class DatePickerCalendarNavigatorPrivate {
   ...
   // QPushButton *current_button;
    ...
    void initUi()
    {
        ...
        previous_button->setSizePolicy(QSizePolicy::Expanding, QSizePolicy::Fixed);
...
void DatePickerCalendarNavigator::setDate(const QDate &date)
{
    ...
    QString current_button_text = QString();
    ...
    d->current_label->setText(current_button_text);
    d->next_button->setText(">");
}
