...
ApxApp.ApxLibrary {
    ...
    Group {
        ...
        files: [
            ...
            "DatabaseSnapshotLookup.cpp", "DatabaseSnapshotLookup.h",
            ...
            "SnapshotsDB.cpp", "SnapshotsDB.h",
            "TelemetryDB.cpp", "TelemetryDB.h",
            "TelemetryReqWrite.cpp", "TelemetryReqWrite.h",
            "TelemetryReqRead.cpp", "TelemetryReqRead.h",
            "DatabaseRelativePointsLookup.cpp", "DatabaseRelativePointsLookup.h",
            "RelativePointsDB.cpp","RelativePointsDB.h",
