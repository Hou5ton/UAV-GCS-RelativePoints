...
Item {
    ...
    Item {
        ...
        Text {
            ...
            text: qsTranslate("MandalaVars", m.mode.text)
        ...
        Rectangle {
            ...
            Column {
                ...
                Number {
                    ...
                    //color: (apx.datalink.valid || m.status_gps.value)?(m.status_gps.value>0?"transparent":"red"):"#80000000"
                    //blinking: apx.datalink.valid && (m.status_gps.value<=0)
        ...
        Item{
            ...
            /*Number {
                id: rpm_number
                visible: ui.test || (value>0 && (!(rpm_error.blink && rpm_error.show)))
                anchors.left: parent.left
                anchors.bottom: parent.bottom
                height: pfdScene.txtHeight
                label: qsTr("RPM")
