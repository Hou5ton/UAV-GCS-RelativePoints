...
CleanButton {
    ...
    function checkButton()
    {
        ...
        if(calibrationazdist){
            if(fact.name === "calibrationedit" &&
                    name === "calibrationedit"){
                calibrationazdist.calibration = true
                if(sendpositionfix){
                    sendpositionfix.position_fix = false
                }
            }else if(fact.name === "calibrationedit" &&
                     name === "missionplanner"){
        ...
        if(sendpositionfix){
            if(fact.name === "positionfixedit" &&
                    name === "positionfixedit"){
                sendpositionfix.position_fix = true
                if(calibrationazdist){
                    calibrationazdist.calibration = false
                }
            }else if(fact.name === "positionfixedit" &&
                     name === "missionplanner"){
                sendpositionfix.position_fix = false
            }
        }
