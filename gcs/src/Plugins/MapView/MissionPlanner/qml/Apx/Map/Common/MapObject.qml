...
MapQuickItem {  //to be used inside MapComponent only
    ...
    property alias contentsTopRP:   containerTopRP.children
    ...
    property alias contentsCenterImage:  containerCenterImage.children
    ...
    function move_to_coo()
    {
        map.move_to_coo(mapObject.coordinate)
    }
    ...
    Item {
        ...
        Column{
            ...
            anchors.horizontalCenter: textItem.right
            anchors.horizontalCenterOffset:textItem.width
        }
        Column{
            id: containerRight
            z: -10
        ...
        MouseArea {
            ...
            onClicked: {
                ...
                if(rulerPlugin &&
                        rulerPlugin.used){
                    rulerPlugin.clickCoordinate = coordinate
                }else{
                    if(selected){
                        triggered()
                    }else{
